# Use Case
>We have a Product table where suppose we have millions of records. Now, in festive season or year ending sale, we want to apply discount to all the existing products.
